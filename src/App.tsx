...
function App() {
  ...
  return (
    ...
    >
      {/* reducedMotion="user" makes Framer's JS-driven animations honor the OS
          preference, which the CSS reset alone can't reach. */}
        ...
        <LazyMotion features={domAnimation} strict>
          <div className="text-text selection:bg-primary/30 relative min-h-screen overflow-hidden bg-[#050505]">
            ...
            <div className="pointer-events-none fixed inset-0 overflow-hidden">
              <div className="absolute top-[-20%] left-[-10%] h-[50vw] w-[50vw] transform-gpu animate-pulse bg-[radial-gradient(circle,var(--color-primary)_0%,transparent_70%)] opacity-10" />
              <div
                className="absolute right-[-10%] bottom-[-20%] h-[50vw] w-[50vw] transform-gpu animate-pulse bg-[radial-gradient(circle,var(--color-secondary)_0%,transparent_70%)] opacity-10"
                style={{ animationDelay: '2s' }}
              />
              <div className="absolute top-[40%] left-[50%] h-[30vw] w-[30vw] -translate-x-1/2 transform-gpu animate-pulse bg-[radial-gradient(circle,var(--color-accent)_0%,transparent_70%)] opacity-5" />
            </div>
